...
export function registerPageCapabilities(
  ...
  client.exposeTool(
    ...
    {
      description:
        "Execute custom JavaScript in the page main world. The script body can return a value.",
      inputSchema: {
        type: "object",
        required: ["source"],
        properties: {
  ...
  client.exposeTool(
    ...
    {
      description:
        "Read the active main-world bridge state, including registered tools and executed script ids.",
