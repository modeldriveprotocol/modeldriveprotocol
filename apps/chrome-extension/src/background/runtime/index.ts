...
import { listGrantedOrigins, listTabs, activateTab, reloadTab, createTab, closeTab, showNotification, openOptionsPage, getActiveTab, resolveTargetTab } from './browser.js'
import { refreshRuntime, getRouteClient, resolvePopupRouteClient, scheduleReconnect, updateRouteClient } from './clients.js'
import { checkMarketSourceUpdatesOnStartup } from './market-sync.js'
import { handleRuntimeMessage } from './messages.js'
import { dispatchPageCommand, ensureScriptsInjected, getMainWorldState, listInjectedTools, safeGetMainWorldState, sendPageCommand } from './page-commands.js'
import { bootstrapOpenTabs, ensureAllowedRouteTab, getPermissionState, requireMatchingActiveTab, resolveAllowedPageTabForRouteClient, syncContentScriptRegistration } from './permissions.js'
import { callInjectedToolForRouteClient, createRouteClientFromActiveTab, getInjectedStateForRouteClient, handleSelectorCapturedMessage, injectToolScriptForRouteClient, listInjectedToolsForRouteClient, listRouteRecordings, listRouteSelectorResources, persistGrantedActiveTabOrigin, runPageCommandForRouteClient, runRouteRecording, startRecording, startSelectorCapture, stopRecording } from './route-sessions.js'
import { getRuntimeStatus } from './status.js'
import { handleTabRemoved, handleTabUpdated } from './tab-lifecycle.js'
import type { ActiveRecordingSession, ManagedClientHandle, PendingSelectorCapture, SelectorCaptureSession } from './types.js'
