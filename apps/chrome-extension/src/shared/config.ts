...
export const DEFAULT_EXTENSION_CONFIG: ExtensionConfig = {
  ...
  clientDescription:
    "Chrome extension bridge that exposes extension and page capabilities through MDP.",
  autoConnect: true,
...
export function normalizeConfig(value: unknown): ExtensionConfig {
  ...
  return {
    ...
    autoInjectBridge:
      readBoolean(record, "autoInjectBridge") ?? DEFAULT_EXTENSION_CONFIG.autoInjectBridge,
    matchPatterns:
