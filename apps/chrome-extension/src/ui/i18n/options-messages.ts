...
export const optionsMessages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'options.clients.createdAt': 'Created ',
    'options.clients.showFiltersAndSelection': 'Show filters and multi-select',
    'options.clients.hideFiltersAndSelection': 'Hide filters and multi-select',
    ...
    'options.clients.pin': 'Pin to top',
    'options.clients.unpin': 'Unpin',
    'options.clients.more': 'More actions',
    'options.clients.copy': 'Copy',
    ...
    'options.clients.defaultPathScript': 'Default path bridge script',
    ...
    'options.invocations.kind.endpoint': 'Endpoint',
    ...
    'options.assets.menu.section.create': 'Create',
    'options.assets.menu.section.createInFolder': 'Create in folder',
    'options.assets.menu.section.file': 'File',
    'options.assets.menu.section.folder': 'Folder',
    'options.assets.menu.section.tree': 'Tree',
    'options.assets.menu.newCode': 'New Code',
    'options.assets.menu.newFolder': 'New Folder',
    'options.assets.menu.newSkill': 'New SKILL.md',
    'options.assets.menu.copyPath': 'Copy Path',
    'options.assets.menu.expandAll': 'Expand All',
    'options.assets.menu.collapseAll': 'Collapse All',
    'options.assets.menu.expandFolder': 'Expand Folder',
    'options.assets.menu.collapseFolder': 'Collapse Folder',
    'options.assets.menu.selectAll': 'Select All',
    'options.assets.menu.clearSelection': 'Clear Selection',
    'options.assets.menu.copySelectedPaths': 'Copy Selected Paths',
    'options.assets.menu.enableSelection': 'Enable Selection',
    'options.assets.menu.disableSelection': 'Disable Selection',
    'options.assets.menu.deleteSelection': 'Delete Selection',
    'options.assets.menu.selectFolderContents': 'Select Folder Contents',
    'options.assets.menu.section.selection': 'Selection',
  ...
  'zh-CN': {
    ...
    'options.clients.createdAt': '创建于 ',
    'options.clients.showFiltersAndSelection': '显示过滤和多选',
    'options.clients.hideFiltersAndSelection': '隐藏过滤和多选',
    ...
    'options.clients.pin': '置顶',
    'options.clients.unpin': '取消置顶',
    'options.clients.more': '更多操作',
    'options.clients.copy': '复制',
    ...
    'options.clients.defaultPathScript': '默认 path bridge 脚本',
    ...
    'options.invocations.kind.endpoint': '端点',
    'options.invocations.kind.prompt': 'Prompt',
    ...
    'options.assets.menu.section.create': '新建',
    'options.assets.menu.section.createInFolder': '在目录中新建',
    'options.assets.menu.section.file': '文件',
    'options.assets.menu.section.folder': '目录',
    'options.assets.menu.section.tree': '目录树',
    'options.assets.menu.newCode': '新建代码',
    'options.assets.menu.newFolder': '新建目录',
    'options.assets.menu.newSkill': '新建 SKILL.md',
    'options.assets.menu.copyPath': '复制路径',
    'options.assets.menu.expandAll': '展开全部',
    'options.assets.menu.collapseAll': '折叠全部',
    'options.assets.menu.expandFolder': '展开目录',
    'options.assets.menu.collapseFolder': '折叠目录',
    'options.assets.menu.selectAll': '全选',
    'options.assets.menu.clearSelection': '清空选择',
    'options.assets.menu.copySelectedPaths': '复制已选路径',
    'options.assets.menu.enableSelection': '启用已选项',
    'options.assets.menu.disableSelection': '停用已选项',
    'options.assets.menu.deleteSelection': '删除已选项',
    'options.assets.menu.selectFolderContents': '选择目录内容',
    'options.assets.menu.section.selection': '已选内容',
