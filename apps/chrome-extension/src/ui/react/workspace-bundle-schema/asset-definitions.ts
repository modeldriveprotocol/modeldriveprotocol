...
export const assetDefinitions = {
  routeSelectorResource: {
    ...
    required: ['id', 'name', 'description', 'createdAt', 'selector', 'alternativeSelectors', 'tagName', 'classes', 'attributes'],
    properties: {
  ...
  marketClientInstallSource: {
    type: 'object',
    additionalProperties: false,
    required: ['type', 'sourceId', 'sourceUrl', 'marketClientId', 'marketVersion', 'installedAt'],
    properties: {
      type: { const: 'market' },
