...
import { Accordion, AccordionDetails, AccordionSummary, Alert, Box, Button, IconButton, List, ListItem, ListItemText, Stack, TextField, Tooltip, Typography } from '@mui/material'
          ...
          <Stack direction="row" spacing={1} alignItems="center" sx={{ minWidth: 0 }}>
            ...
            <Box sx={{ minWidth: 0 }}>
              ...
              <Typography variant="caption" color="text.secondary" noWrap>
                {client.routeRuleSummary ?? client.matchPatterns[0] ?? controller.t('popup.noRouteRules')}
              </Typography>
            </Box>
          </Stack>
                ...
                <ListItem
                  ...
                  secondaryAction={
                    <Tooltip title={controller.t('popup.replayFlow')}>
                      <IconButton edge="end" size="small" onClick={() => void controller.runAction(controller.t('popup.replayedFlow'), async () => { if (client.id) await runRecording(client.id, recording.id) })}>
