...
| Check exact HTTP request and response contracts   | [POST /mdp/http-loop/connect](/server/api/http-loop-connect), [POST /mdp/auth](/server/api/auth-issue)         |

## Connection Setup

| Surface                                       | Entry point              | Notes                                                 |
| --------------------------------------------- | ------------------------ | ----------------------------------------------------- |
| [WebSocket](/server/api/websocket-connection) | `ws://127.0.0.1:7070`    | Bidirectional JSON MDP messages                       |
